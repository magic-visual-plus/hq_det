...
def run_train_lwdetr(args, class_names):
    from hq_det.trainer import HQTrainerArguments
    from hq_det.tools.train_lwdetr import MyTrainer
    ...
    trainer = MyTrainer(
        HQTrainerArguments(
            ...
            model_argument={
                "resume": args.load_checkpoint,
                "model_name": args.model_name,
                "id2names": class_names,
                "device": args.device,
...
def get_args():
    ...
    parser.add_argument('--model_name', type=str, default='lwdetr_large_coco', help='Model name')
...
if __name__ == '__main__':
    ...
    trainer = run_train_lwdetr(args, class_names)
