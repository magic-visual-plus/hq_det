import sys
from hq_det.models import dino_swin
...
class MyTrainer(HQTrainer):
    ...
    def build_model(self):
        ...
        model = dino_swin.HQDINO_SWIN(class_id2names=id2names, **self.args.model_argument)
        return model
    ...
    def collate_fn(self, batch):
        ...
        batch_data = dino_swin.HQDINO_SWIN.imgs_to_batch(images, boxes=boxes_xyxy, labels=labels)
...
def run(
        ...
        config_name='dino_swin_tiny_224_4scale_12ep',
    ):
    trainer = MyTrainer(
        HQTrainerArguments(
            data_path=data_path,
