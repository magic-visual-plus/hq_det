...
"""
本配置文件修改自 CO-DETR 的 co_dino_5scale_swin_large_16e_o365tococo.py
主要修改内容:
1. 修改了 pretrained 和 load_from 路径, 通过环境变量设置
2. 添加了 codetr 相关模块的导入和配置

所有修改过的模块均使用 HACK 标记, 以方便后续修改
"""
import os   # HACK: 添加 os 模块

pretrained = 'https://github.com/SwinTransformer/storage/releases/download/v1.0.0/swin_large_patch4_window12_384_22k.pth'  # noqa
pretrained = os.environ.get('PRETRAINED', pretrained)   # HACK: 修改原有配置, 通过环境变量设置
...
load_from = os.environ.get('LOAD_FROM', load_from)   # HACK: 修改原有配置, 通过环境变量设置
